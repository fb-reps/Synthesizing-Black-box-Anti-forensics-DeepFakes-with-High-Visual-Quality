"""
in parallel thread, extract frames from folder in certain frameFrequency
"""
...
path = '/home/ncubigdata1/Documents/fanbing_documents_own/DFData/FFPP/fake_videos/'
files = os.listdir(path)
outputDirName = '/home/ncubigdata1/Documents/fanbing_documents_own/DFData/FFPP/fake/'
...
pool = mp.Pool(64)
pool.map_async(video2image, files)
# print(set(fileList) - set(finishList))
pool.close()
pool.join()
